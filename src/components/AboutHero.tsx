        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="flex-1">
            ...
            <div className="inline-block mb-8">
              <LiquidGlass className="px-3 py-1.5 rounded-lg !bg-zinc-900/80">
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              <div className="text-center">
                <div className="text-2xl font-bold text-zinc-900 mb-1">15+</div>
                <div className="text-xs text-zinc-600">Projects</div>
              </div>
              <div className="text-center border-x border-zinc-300">
                <div className="text-2xl font-bold text-zinc-900 mb-1">12+</div>
                <div className="text-xs text-zinc-600">Years</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-zinc-900 mb-1">5+</div>
                <div className="text-xs text-zinc-600">Companies</div>
              </div>
            </div>
