...
export const PageRails = () => {
  return (
    <nav aria-label="Pages" className="home-grid-rails">
      ...
      <p
        className="flex h-9 items-center justify-between gap-x-6 overflow-x-auto px-[var(--pad)] text-[11px] font-medium uppercase leading-none tracking-[0.18em] text-[var(--text-secondary)]"
        style={serif}
      >
        {elsewhere.map((item) => (
          <a
